...
-   `--update-details <data>`<br/>String with the connection server details in JSON format

-   `--update-details-file <file>`<br/>File with the connection server details in JSON format
...
-   `--dax <query>`<br/>String with the DAX query to be executed

-   `--dax-file <file>`<br/>File with the DAX query to be executed

-   `--script <script>`<br/>String with the raw query statement in JSON format

-   `--script-file <file>`<br/>File with the raw query statement in JSON format
